    ...
    <div className='MainPage'>
      ...
      <div className='about-us1'>
        <div className='about-us' id='1'>
          ...
          <hr className='line-b'/>
          <p className='about-us-txt element-to-animate'>Для вас в наличии входные и межкомнатные двери, дверная фурнитура и напольное покрытие. Новинки всех производителей у нас и только для вас. Квалифицированные сотрудники, индивидуальный подход, консультация по подбору товара. Доставка в любой район города и края. Профессиональная и качественная установка дверей с гарантией от магазина. Мы ждём вас!</p>
        </div>
      </div>
